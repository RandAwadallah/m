    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        viewHolder.view_container.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("pharmacy_name", mData.get(viewHolder.getAdapterPosition()).getName());
                ...
                i.putExtra("address", mData.get(viewHolder.getAdapterPosition()).getAdress());
...
TextView tv_adress;
        ...
        public MyViewHolder(View itemView) {
            ...
            tv_name = itemView.findViewById(R.id.pharmacy_name);
            tv_adress = itemView.findViewById(R.id.address);
